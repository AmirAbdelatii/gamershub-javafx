 ...
 * @author meriam
 */
public class AddTeamFrontController implements Initializable {
    ...
    private void cancel(ActionEvent event) {
        try {
            ...
            ((HomeFrontController) homeLoader.getController()).changePage("btnTeam");
                cancel.getScene().setRoot(homeNode);
            } catch (IOException ex) {
                Logger.getLogger(TeamFrontContentController.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
    @FXML
    ...
    private void upload(ActionEvent event) {
        ...
        if (file != null) {
           ...
           String fileName = sb.toString();
            ...
            File source = file;
            File dest = new File("C:\\Users\\LENOVO\\OneDrive\\Bureau\\Master-JavaFxProject-Copie\\src\\gamershub\\images" + fileName + ".png");
